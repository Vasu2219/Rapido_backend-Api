...
// Hard-coded config to avoid dotenv issues
const config = {
  MONGODB_URI: 'mongodb://localhost:27017/rapido-corporate',
  JWT_SECRET: 'your_super_secret_jwt_key_for_rapido_corporate_ride_booking_system_2024',
  JWT_EXPIRES_IN: '7d',
